...
# set to path that contains model fit files
basepath <- './scripts/4.comparative_analyses/model-fits/'

skull <- read.csv(paste(basepath, "fit_skull.csv", sep="")) 
mass  <- read.csv(paste(basepath, "fit_mass.csv", sep=""))
vert  <- read.csv(paste(basepath, "fit_vert.csv", sep=""))
elong <- read.csv(paste(basepath, "fit_elong.csv", sep=""))
diet  <- read.csv(paste(basepath, "fit_diet.csv", sep=""))
climate <- read.csv(paste(basepath, "fit_climate.csv", sep=""))
